...
//视频广告ID
var video_ad_ids = '1748806521876728_1748862235204490';
//插屏广告ID
var interstitial_ad_ids = '1748806521876728_1748861741871206';
//游戏ID
var game_id = "1748806521876728";
...
FB_SDK.prototype.doShare = function (score) {
    var self = this;
    var en_text = self.getName() + " Allready get " + score + " stars,Can you beat me?";
    var cn_text = self.getName() + " 向你发起挑战！他已经有了 " + score + " 个星星！";
